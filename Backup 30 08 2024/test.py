...
class GraphDataProcessor:
    ...
    def prepare_graph_data(self):
        ...
        # No need to balance or shuffle the test dataset
        ...
        # Print or log the number of edges
        num_edges = edge_index.size(1)
        logging.info(f"Number of edges: {num_edges}")
        print(f"Number of edges: {num_edges}")  # If you prefer to print instead of logging
